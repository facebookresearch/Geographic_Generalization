...
class ALBEFClassifierModule(ClassifierModule):
    """"""
    ...
    def __init__(
        ...
        if dataset_to_use_for_classes == "Imagenet":
            ...
            raise Exception(
                "ALBEFClassifierModule accepts two options for the 'dataset_to_use_for_classes' parameter: Imagenet or Geode"
            )
...
class BLIPClassifierModule(ClassifierModule):
    """Reference: https://github.com/salesforce/LAVIS/blob/main/examples/blip_zero_shot_classification.ipynb"""
    ...
    def __init__(
        ...
        if dataset_to_use_for_classes == "Imagenet":
            ...
            raise Exception(
                "BLIPClassifierModule accepts two options for the 'dataset_to_use_for_classes' parameter: Imagenet or Geode"
            )
    ...
    def load_model(self):
        ...
        self.processor = BlipCaptionProcessor(prompt="A picture of ")
        self.processed_class_names = [
            self.processor(cls_nm) for cls_nm in self.class_list
        ]
